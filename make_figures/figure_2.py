...
axs[2].set_ylabel("Mean ply count")
...
# formatting
axs[0].yaxis.set_major_formatter(ticker.FuncFormatter(
    lambda x, pos: '{:,.0f}'.format(x/1000) + 'K'))
axs[1].yaxis.set_major_formatter(ticker.FuncFormatter(
    lambda x, pos: '{:,.0f}'.format(x/1000) + 'K'))
...
axs[0].text(-0.225, 1.0, "A", transform=axs[0].transAxes,
            fontsize=12, fontweight='bold', va='top', ha='right')
axs[1].text(-0.225, 1.0, "B", transform=axs[1].transAxes,
            fontsize=12, fontweight='bold', va='top', ha='right')
axs[2].text(-0.225, 1.0, "C", transform=axs[2].transAxes,
            fontsize=12, fontweight='bold', va='top', ha='right')
axs[3].text(-0.22, 1.0, "D", transform=axs[3].transAxes,
            fontsize=12, fontweight='bold', va='top', ha='right')
