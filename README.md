...
2. Use [Scid vs. PC](https://scidvspc.sourceforge.net) to export all games into a PGN file. Save the result as `data/pgn/caissa.pgn`. (Use [this guide](https://chess.stackexchange.com/questions/13116/how-do-you-convert-a-scid-database-into-a-pgn-database))
